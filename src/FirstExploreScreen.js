      ...
      <View style={styles.container}>
          {
            ocultarTexto && (
              <View style={styles.center}>
                ...
                <Text style={[styles.submitText, { fontFamily: 'BreeSerif' }]}>VERMILLION</Text>
                </TouchableHighlight>
          ...
          <View style={styles.center}>
            <View style={styles.oneLine}>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item1} onChangeText={(value) => setItem1(value)} onTouchStart={()=> pressInputOpen() } /> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item2} onChangeText={(value) => setItem2(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}   maxLength={1} value={item3} onChangeText={(value) => setItem3(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <Text style={[styles.inputStatic, {fontFamily: 'BreeSerif'}]}> M </Text> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item5} onChangeText={(value) => setItem5(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item6} onChangeText={(value) => setItem6(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item7} onChangeText={(value) => setItem7(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <Text style={[styles.inputStatic, {fontFamily: 'BreeSerif'}]}> I </Text> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item9} onChangeText={(value) => setItem9(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
              <View> 
                <TextInput style={[styles.input, {fontFamily: 'BreeSerif'}]}  maxLength={1} value={item10} onChangeText={(value) => checkWrite(value)} onTouchStart={()=> pressInputOpen() }/> 
              </View>
            </View>
          </View>
